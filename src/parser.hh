...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // termino
      // factor
      char dummy7[sizeof (std::unique_ptr<ExprAST>)];

      // funcs
      char dummy8[sizeof (std::unique_ptr<FuncDeclStmt>)];

      // condicion
      char dummy9[sizeof (std::unique_ptr<IfStmnt>)];
    ...
    TOK_ID = 3,                    // ID
    TOK_LETRERO = 4,               // LETRERO
    TOK_CTE_ENT = 5,               // CTE_ENT
    TOK_CTE_FLOT = 6,              // CTE_FLOT
    TOK_PROGRAMA = 7,              // "programa"
    TOK_INICIO = 8,                // "inicio"
    TOK_FIN = 9,                   // "fin"
    TOK_VARS = 10,                 // "vars"
    TOK_ENT = 11,                  // "entero"
    TOK_FLOT = 12,                 // "flotante"
    TOK_NULO = 13,                 // "nulo"
    TOK_DO = 14,                   // "haz"
    TOK_WHILE = 15,                // "mientras"
    TOK_IF = 16,                   // "si"
    TOK_ELSE = 17,                 // "sino"
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_LETRERO = 4,                           // LETRERO
        S_CTE_ENT = 5,                           // CTE_ENT
        S_CTE_FLOT = 6,                          // CTE_FLOT
        S_PROGRAMA = 7,                          // "programa"
        S_INICIO = 8,                            // "inicio"
        S_FIN = 9,                               // "fin"
        S_VARS = 10,                             // "vars"
        S_ENT = 11,                              // "entero"
        ...
        switch (this->kind ())
    {
      ...
      case symbol_kind::S_factor: // factor
        value.move< std::unique_ptr<ExprAST> > (std::move (that.value));
        break;

      case symbol_kind::S_funcs: // funcs
        value.move< std::unique_ptr<FuncDeclStmt> > (std::move (that.value));
        break;

      case symbol_kind::S_condicion: // condicion
        value.move< std::unique_ptr<IfStmnt> > (std::move (that.value));
        break;
      ...
      case symbol_kind::S_asigna: // asigna
        value.move< std::unique_ptr<StmntAST> > (std::move (that.value));
        break;
      ...
      case symbol_kind::S_sino: // sino
        value.move< std::vector<std::unique_ptr<StmntAST>> > (std::move (that.value));
        break;
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::unique_ptr<CallExpr>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::unique_ptr<CallExpr>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::unique_ptr<ExprAST>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::unique_ptr<ExprAST>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::unique_ptr<FuncDeclStmt>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::unique_ptr<FuncDeclStmt>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::unique_ptr<IfStmnt>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::unique_ptr<IfStmnt>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::unique_ptr<ParamVarDecl>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::unique_ptr<StmntAST>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::unique_ptr<StmntAST>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::vector<std::unique_ptr<ExprAST>>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::vector<std::unique_ptr<ExprAST>>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::vector<std::unique_ptr<FuncDeclStmt>>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::vector<std::unique_ptr<FuncDeclStmt>>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::vector<std::unique_ptr<ParamVarDecl>>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::vector<std::unique_ptr<ParamVarDecl>>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::vector<std::unique_ptr<StmntAST>>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::vector<std::unique_ptr<StmntAST>>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::vector<std::unique_ptr<VarDeclStmt>>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::vector<std::unique_ptr<VarDeclStmt>>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
switch (yykind)
    {
      ...
      case symbol_kind::S_termino: // termino
      case symbol_kind::S_factor: // factor
        value.template destroy< std::unique_ptr<ExprAST> > ();
        break;

      case symbol_kind::S_funcs: // funcs
        value.template destroy< std::unique_ptr<FuncDeclStmt> > ();
        break;

      case symbol_kind::S_condicion: // condicion
        value.template destroy< std::unique_ptr<IfStmnt> > ();
        break;
      ...
      case symbol_kind::S_ciclo: // ciclo
      case symbol_kind::S_asigna: // asigna
        value.template destroy< std::unique_ptr<StmntAST> > ();
        break;
      ...
      case symbol_kind::S_adentro: // adentro
      case symbol_kind::S_sino: // sino
        value.template destroy< std::vector<std::unique_ptr<StmntAST>> > ();
        break;
    ...
    struct symbol_type : basic_symbol<by_kind>
    {
      ...
      {
#if !defined _MSC_VER || defined __clang__
        YY_ASSERT (tok == token::TOK_CTE_FLOT);
#endif
      }
#if 201103L <= YY_CPLUSPLUS
      ...
      {
#if !defined _MSC_VER || defined __clang__
        YY_ASSERT (tok == token::TOK_CTE_ENT);
#endif
      }
#if 201103L <= YY_CPLUSPLUS
      ...
      {
#if !defined _MSC_VER || defined __clang__
        YY_ASSERT ((token::TOK_ID <= tok && tok <= token::TOK_LETRERO));
#endif
      }
    };
    ...
    // Implementation of make_symbol for each token kind.
      ...
      static
      symbol_type
      make_LETRERO (std::string v, location_type l)
      {
        return symbol_type (token::TOK_LETRERO, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_LETRERO (const std::string& v, const location_type& l)
      {
        return symbol_type (token::TOK_LETRERO, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_CTE_ENT (long v, location_type l)
      {
        return symbol_type (token::TOK_CTE_ENT, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_CTE_ENT (const long& v, const location_type& l)
      {
        return symbol_type (token::TOK_CTE_ENT, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_CTE_FLOT (double v, location_type l)
      {
        return symbol_type (token::TOK_CTE_FLOT, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_CTE_FLOT (const double& v, const location_type& l)
      {
        return symbol_type (token::TOK_CTE_FLOT, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_INICIO (location_type l)
      {
        return symbol_type (token::TOK_INICIO, std::move (l));
      }
#else
      static
      symbol_type
      make_INICIO (const location_type& l)
      {
        return symbol_type (token::TOK_INICIO, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_VARS (location_type l)
      {
        return symbol_type (token::TOK_VARS, std::move (l));
      }
#else
      static
      symbol_type
      make_VARS (const location_type& l)
      {
        return symbol_type (token::TOK_VARS, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      {
        return symbol_type (token::TOK_ENT, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::TOK_ENT, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_FLOT (location_type l)
      {
        return symbol_type (token::TOK_FLOT, std::move (l));
      }
#else
      static
      symbol_type
      make_FLOT (const location_type& l)
      {
        return symbol_type (token::TOK_FLOT, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_NULO (location_type l)
      {
        return symbol_type (token::TOK_NULO, std::move (l));
      }
#else
      static
      symbol_type
      make_NULO (const location_type& l)
      {
        return symbol_type (token::TOK_NULO, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
    ...
    , location (that.location)
  {
    switch (this->kind ())
    {
      ...
      case symbol_kind::S_termino: // termino
      case symbol_kind::S_factor: // factor
        value.copy< std::unique_ptr<ExprAST> > (YY_MOVE (that.value));
        break;

      case symbol_kind::S_funcs: // funcs
        value.copy< std::unique_ptr<FuncDeclStmt> > (YY_MOVE (that.value));
        break;

      case symbol_kind::S_condicion: // condicion
        value.copy< std::unique_ptr<IfStmnt> > (YY_MOVE (that.value));
        break;
      ...
      case symbol_kind::S_ciclo: // ciclo
      case symbol_kind::S_asigna: // asigna
        value.copy< std::unique_ptr<StmntAST> > (YY_MOVE (that.value));
        break;
      ...
      case symbol_kind::S_adentro: // adentro
      case symbol_kind::S_sino: // sino
        value.copy< std::vector<std::unique_ptr<StmntAST>> > (YY_MOVE (that.value));
        break;
  ...
  parser::basic_symbol<Base>::move (basic_symbol& s)
  {
    ...
    switch (this->kind ())
    {
      ...
      case symbol_kind::S_termino: // termino
      case symbol_kind::S_factor: // factor
        value.move< std::unique_ptr<ExprAST> > (YY_MOVE (s.value));
        break;

      case symbol_kind::S_funcs: // funcs
        value.move< std::unique_ptr<FuncDeclStmt> > (YY_MOVE (s.value));
        break;

      case symbol_kind::S_condicion: // condicion
        value.move< std::unique_ptr<IfStmnt> > (YY_MOVE (s.value));
        break;
      ...
      case symbol_kind::S_ciclo: // ciclo
      case symbol_kind::S_asigna: // asigna
        value.move< std::unique_ptr<StmntAST> > (YY_MOVE (s.value));
        break;
      ...
      case symbol_kind::S_adentro: // adentro
      case symbol_kind::S_sino: // sino
        value.move< std::vector<std::unique_ptr<StmntAST>> > (YY_MOVE (s.value));
        break;
